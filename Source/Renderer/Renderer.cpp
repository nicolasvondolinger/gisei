...
void Renderer::CreateSpriteVerts() {
    float vertices[] = {
        ...
        -0.5f, -0.5f, 0.0f,     0.0f, 0.0f, // 0: Vértice inferior esquerdo
        -0.5f,  0.5f, 0.0f,     0.0f, 1.0f, // 1: Vértice superior esquerdo
         0.5f,  0.5f, 0.0f,     1.0f, 1.0f, // 2: Vértice superior direito
         0.5f, -0.5f, 0.0f,     1.0f, 0.0f  // 3: Vértice inferior direito
    };

    unsigned int indices[] = {
        0, 1, 2,  // Primeiro triângulo (inf-esq, sup-esq, sup-dir)
        2, 3, 0   // Segundo triângulo (sup-dir, inf-dir, inf-esq)
    };
...
Texture* Renderer::GetTexture(const string& fileName, bool repeat)
{
    Texture* tex = nullptr;
